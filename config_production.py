...
class ProductionConfig(Config):
    ...
    # Language Detection Settings - Production
    LANGUAGE_DETECTION_CONFIDENCE_THRESHOLD = float(os.environ.get("SARA_LANG_CONFIDENCE_THRESHOLD", "0.70"))  # Higher threshold for production
